python ../resave_intrinsic.py \
    --output_dir='/nas/users/dahye/save_pretrained/intrinsic_resave/airplane' \
    --monitor_interval=50 \
    --num_plot_img=32 \
    --height=64 \
    --width=64 \
    ...
    --trained_intrinsic_ckpt_path='/nas/users/dahye/mygit/shape-gan-seg/pretrained/intrinsic_lsun/lsun_airplane/model/l1001_l2150_im00001_lri1e-06-5e-05-1e-06_bs128_nep600_best_loss.pth' \
    --num_in_channel=3 \
    --num_out_channel=3 \
    --gamma1_tv_seg=0.01 \
